...
"bpe_debug":False,
"bpe_dropout":None,
"bpe_merge":"./ParlAI/data/models/blenderbot2/blenderbot2_3B/model.dict-merges.txt",
"bpe_vocab":"./ParlAI/data/models/blenderbot2/blenderbot2_3B/model.dict-vocab.json",
"candidates":'inline',
...
"dict_file":"./ParlAI/data/models/blenderbot2/blenderbot2_3B/model.dict",
"dict_initpath":None,
"dict_language":"english", #the pretrained model is in english
"dict_loaded":True,
"dict_lower":False,
...
"inference":"topk", #beam,nucleus,topk
"init_fairseq_model":None,
"init_model":"/private/home/kshuster/ParlAI/data/models/blender/blender_3B/model",
"init_opt":None,
...
"is_debug":False,
"knowledge_access_method":"memory_only",#also all,search-only
"label_truncate":128,
...
"model_file":"./ParlAI/data/models/blenderbot2/blenderbot2_3B/model",
"model_parallel":True,
"momentum":0,
...
"output_scaling":1.0,
"override":{'model_file':'./ParlAI/data/models/blenderbot2/blenderbot2_3B/model', 'search_server':'None', 'knowledge_access_method':'memory_only'},
...
"thorough":False,
"topk":10,
"topp":0.9, #default 0.9 (probability for nucleus inference)
"train_predict":False,
"truncate":128,
"update_freq":1,
"use_memories":True,
